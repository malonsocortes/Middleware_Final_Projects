...
# 50 "/usr/include/x86_64-linux-gnu/sys/select.h" 3
...
#line 702
typedef int (*__compar_fn_t)(const void *arg_0x7fe045b2e020, const void *arg_0x7fe045b2e2f8);
#line 740
__extension__ 
#line 757
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fe045aab9c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 343
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fe0458658e8), 
int (*key_eq_fn)(void *arg_0x7fe0458640c8, void *arg_0x7fe045864368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fe045662610, int arg_0x7fe045662878);
static double RandomUniform(void );
...
typedef TMilli TemperatureMonitorC$TimerSensor$precision_tag;
typedef TMilli TemperatureMonitorC$TimerSink$precision_tag;
typedef uint16_t TemperatureMonitorC$Temperature$val_t;
typedef TMilli TemperatureMonitorC$WaitingTimer$precision_tag;
...
typedef TMilli /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$precision_tag;
typedef uint16_t /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$val_t;
typedef uint16_t RandomMlcgC$SeedInit$parameter;
# 113 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static void TemperatureMonitorC$AMControl$startDone(error_t error);
#line 138
static void TemperatureMonitorC$AMControl$stopDone(error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void TemperatureMonitorC$sendSETUP$runTask(void );
# 60 "/usr/src/tinyos/tos/interfaces/Boot.nc"
static void TemperatureMonitorC$Boot$booted(void );
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void TemperatureMonitorC$forwardSETUP$runTask(void );
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void TemperatureMonitorC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void TemperatureMonitorC$forwardDATA$runTask(void );
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TemperatureMonitorC$TimerSensor$fired(void );
#line 83
static void TemperatureMonitorC$TimerSink$fired(void );
...
TemperatureMonitorC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
static void TemperatureMonitorC$Temperature$readDone(error_t result, TemperatureMonitorC$Temperature$val_t val);
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TemperatureMonitorC$WaitingTimer$fired(void );
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void TemperatureMonitorC$sendDATA$runTask(void );
...
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$fired(void );
# 55 "/usr/src/tinyos/tos/interfaces/Read.nc"
static error_t /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$read(void );
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t TemperatureMonitorC$AMControl$start(void );
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static error_t TemperatureMonitorC$sendSETUP$postTask(void );
#line 67
static error_t TemperatureMonitorC$forwardSETUP$postTask(void );
...
TemperatureMonitorC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t TemperatureMonitorC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static error_t TemperatureMonitorC$forwardDATA$postTask(void );
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TemperatureMonitorC$TimerSensor$startPeriodic(uint32_t dt);
#line 78
static void TemperatureMonitorC$TimerSensor$stop(void );
# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
static uint16_t TemperatureMonitorC$Random$rand16(void );
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TemperatureMonitorC$TimerSink$startPeriodic(uint32_t dt);
#line 78
static void TemperatureMonitorC$TimerSink$stop(void );
# 55 "/usr/src/tinyos/tos/interfaces/Read.nc"
static error_t TemperatureMonitorC$Temperature$read(void );
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TemperatureMonitorC$WaitingTimer$startOneShot(uint32_t dt);
# 88 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
static am_addr_t TemperatureMonitorC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t TemperatureMonitorC$AMPacket$destination(
#line 74
message_t * amsg);
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static error_t TemperatureMonitorC$sendDATA$postTask(void );
# 53 "TemperatureMonitorC.nc"
enum TemperatureMonitorC$__nesc_unnamed4324 {
#line 53
  TemperatureMonitorC$sendSETUP = 0U
};
#line 53
typedef int TemperatureMonitorC$__nesc_sillytask_sendSETUP[TemperatureMonitorC$sendSETUP];
#line 76
enum TemperatureMonitorC$__nesc_unnamed4325 {
#line 76
  TemperatureMonitorC$forwardSETUP = 1U
};
#line 76
typedef int TemperatureMonitorC$__nesc_sillytask_forwardSETUP[TemperatureMonitorC$forwardSETUP];
#line 97
enum TemperatureMonitorC$__nesc_unnamed4326 {
#line 97
  TemperatureMonitorC$sendDATA = 2U
};
#line 97
typedef int TemperatureMonitorC$__nesc_sillytask_sendDATA[TemperatureMonitorC$sendDATA];
#line 123
enum TemperatureMonitorC$__nesc_unnamed4327 {
#line 123
  TemperatureMonitorC$forwardDATA = 3U
};
#line 123
typedef int TemperatureMonitorC$__nesc_sillytask_forwardDATA[TemperatureMonitorC$forwardDATA];
#line 36
uint16_t TemperatureMonitorC$threshold[1000];
uint16_t TemperatureMonitorC$temperature[1000];
uint16_t TemperatureMonitorC$maxTemp[1000];
uint16_t TemperatureMonitorC$counter[1000];
uint8_t TemperatureMonitorC$dataCounter[1000];
uint16_t TemperatureMonitorC$sentCounter[1000];
uint16_t TemperatureMonitorC$measurements[1000];

bool TemperatureMonitorC$busy[1000];

message_t TemperatureMonitorC$pkt[1000];
setup_msg_t TemperatureMonitorC$setup_pkt[1000];
data_msg_t TemperatureMonitorC$data_pkt[1000];

am_addr_t TemperatureMonitorC$prev_node[1000];


static inline void TemperatureMonitorC$sendSETUP$runTask(void );
#line 76
static inline void TemperatureMonitorC$forwardSETUP$runTask(void );
#line 97
static inline void TemperatureMonitorC$sendDATA$runTask(void );
#line 123
static inline void TemperatureMonitorC$forwardDATA$runTask(void );
#line 144
...
#line 197
static inline void TemperatureMonitorC$TimerSink$fired(void );
...
static inline void TemperatureMonitorC$TimerSensor$fired(void );



static inline void TemperatureMonitorC$WaitingTimer$fired(void );



static inline void TemperatureMonitorC$Temperature$readDone(error_t err, uint16_t val);
#line 225
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/usr/src/tinyos/tos/interfaces/Read.nc"
static void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$readDone(error_t result, /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$val_t val);
# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
static uint16_t /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Random$rand16(void );
# 20 "TemperatureSensorP.nc"
static inline error_t /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$read(void );




static inline void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$fired(void );
...
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t TemperatureMonitorC$forwardDATA$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TemperatureMonitorC$forwardDATA);
#line 67
...
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void TemperatureMonitorC$WaitingTimer$startOneShot(uint32_t dt){
#line 73
...
#line 73
# 78 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static am_addr_t TemperatureMonitorC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
#line 225
{
  ...
  source_node = TemperatureMonitorC$AMPacket$source(msg);
  dest_node = TemperatureMonitorC$AMPacket$destination(msg);
  ...
  if (TOS_NODE_ID == 0) {
      ...
      if (len == sizeof(data_msg_t )) {
          ...
          sim_log_debug(59U, "radio", "%s | Node 0 | Received DATA (ID = %d): sender = ID%d, origin = ID%d, temp = %d > threshold\n", sim_time_string(), __nesc_ntoh_uint8(data->msg_id.nxdata), source_node, __nesc_ntoh_uint16(data->node_id.nxdata), __nesc_ntoh_uint16(data->temperature.nxdata));

          TemperatureMonitorC$dataCounter[sim_node()]++;
          if (__nesc_ntoh_uint16(data->temperature.nxdata) > TemperatureMonitorC$maxTemp[sim_node()]) {
            TemperatureMonitorC$maxTemp[sim_node()] = __nesc_ntoh_uint16(data->temperature.nxdata);
            }
        }
    }
  else 
#line 248
    {
      ...
      if (len == sizeof(setup_msg_t )) {
          ...
          sim_log_debug(60U, "radio", "%s | Node %d | Received SETUP (ID = %d): sender = ID%d, origin = ID%d, threshold = %d\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint16(setup->msg_id.nxdata), source_node, __nesc_ntoh_uint16(setup->sender_id.nxdata), __nesc_ntoh_uint16(setup->threshold.nxdata));


          if (__nesc_ntoh_uint16(setup->msg_id.nxdata) > TemperatureMonitorC$counter[sim_node()]) {
              TemperatureMonitorC$counter[sim_node()] = __nesc_ntoh_uint16(setup->msg_id.nxdata);
              TemperatureMonitorC$threshold[sim_node()] = __nesc_ntoh_uint16(setup->threshold.nxdata);
              TemperatureMonitorC$prev_node[sim_node()] = source_node;
              TemperatureMonitorC$setup_pkt[sim_node()] = *setup;

              TemperatureMonitorC$WaitingTimer$startOneShot(80 + TOS_NODE_ID * 15);
            }
        }
      else {
#line 264
        if (len == sizeof(data_msg_t )) {
            data = (data_msg_t *)payload;
            sim_log_debug(61U, "radio", "%s | Node %d | Received DATA (ID = %d): sender = ID%d, origin = ID%d, forwardto = ID%d\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint8(data->msg_id.nxdata), source_node, __nesc_ntoh_uint16(data->node_id.nxdata), TemperatureMonitorC$prev_node[sim_node()]);

            TemperatureMonitorC$data_pkt[sim_node()] = *data;
            if (dest_node == TOS_NODE_ID) {
                TemperatureMonitorC$forwardDATA$postTask();
              }
          }
        }
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7fe0451cd1a0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fe0451cd1a0) {
#line 78
    case 231:
#line 78
      __nesc_result = TemperatureMonitorC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7fe0451cd1a0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7fe0451cdce8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7fe0451cdce8, msg, payload, len);
#line 78
...
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t TemperatureMonitorC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * TemperatureMonitorC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 60
      TemperatureMonitorC$counter[sim_node()]++;

      msg = (setup_msg_t *)TemperatureMonitorC$Packet$getPayload(&TemperatureMonitorC$pkt[sim_node()], sizeof(setup_msg_t ));
      if (msg == (void *)0) {
#line 63
        return;
        }
#line 64
      ...
      __nesc_hton_uint16(msg->msg_id.nxdata, TemperatureMonitorC$counter[sim_node()]);
      __nesc_hton_uint16(msg->threshold.nxdata, TemperatureMonitorC$threshold[sim_node()]);

      if (TemperatureMonitorC$AMSend$send(AM_BROADCAST_ADDR, &TemperatureMonitorC$pkt[sim_node()], sizeof(setup_msg_t )) == SUCCESS) {
          TemperatureMonitorC$busy[sim_node()] = TRUE;
          sim_log_debug(46U, "radio", "%s | Node 0 | Sent SETUP (ID=%d): threshold = %d\n", sim_time_string(), __nesc_ntoh_uint16(msg->msg_id.nxdata), __nesc_ntoh_uint16(msg->threshold.nxdata));
        }
    }
}
...
#line 80
  ...
  sim_log_debug(47U, "nodes", "%s | Node %d | Must forward SETUP\n", sim_time_string(), TOS_NODE_ID);
...
#line 86
  __nesc_hton_uint16(msg->sender_id.nxdata, __nesc_ntoh_uint16(TemperatureMonitorC$setup_pkt[sim_node()].sender_id.nxdata));
  __nesc_hton_uint16(msg->msg_id.nxdata, __nesc_ntoh_uint16(TemperatureMonitorC$setup_pkt[sim_node()].msg_id.nxdata));
  __nesc_hton_uint16(msg->threshold.nxdata, __nesc_ntoh_uint16(TemperatureMonitorC$setup_pkt[sim_node()].threshold.nxdata));

  if (TemperatureMonitorC$AMSend$send(AM_BROADCAST_ADDR, &TemperatureMonitorC$pkt[sim_node()], sizeof(setup_msg_t )) == SUCCESS) {
      TemperatureMonitorC$busy[sim_node()] = TRUE;
      sim_log_debug(48U, "radio", "%s | Node %d | Forwarded SETUP (ID=%d): threshold = %d\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint16(msg->msg_id.nxdata), __nesc_ntoh_uint16(msg->threshold.nxdata));
    }
}
...
#line 104
      ...
      sim_log_debug(49U, "nodes", "%s | Node %d | Temperature above threshold (%d > %d). Must inform Sink\n", sim_time_string(), TOS_NODE_ID, TemperatureMonitorC$temperature[sim_node()], TemperatureMonitorC$threshold[sim_node()]);


      msg = (data_msg_t *)TemperatureMonitorC$Packet$getPayload(&TemperatureMonitorC$pkt[sim_node()], sizeof(data_msg_t ));
      if (msg == (void *)0) {
#line 110
        return;
        }
#line 111
      __nesc_hton_uint16(msg->node_id.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(msg->msg_id.nxdata, TemperatureMonitorC$dataCounter[sim_node()]);
      __nesc_hton_uint16(msg->temperature.nxdata, TemperatureMonitorC$temperature[sim_node()]);

      if (TemperatureMonitorC$AMSend$send(TemperatureMonitorC$prev_node[sim_node()], &TemperatureMonitorC$pkt[sim_node()], sizeof(data_msg_t )) == SUCCESS) {
          TemperatureMonitorC$busy[sim_node()] = TRUE;
          sim_log_debug(50U, "radio", "%s | Node %d | Sent DATA (ID=%d): temp = %d\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint8(msg->msg_id.nxdata), __nesc_ntoh_uint16(msg->temperature.nxdata));
        }
    }
}
...
#line 127
  ...
  sim_log_debug(51U, "nodes", "%s | Node %d | Must forward DATA\n", sim_time_string(), TOS_NODE_ID);
...
#line 133
  __nesc_hton_uint16(msg->node_id.nxdata, __nesc_ntoh_uint16(TemperatureMonitorC$data_pkt[sim_node()].node_id.nxdata));
  __nesc_hton_uint8(msg->msg_id.nxdata, __nesc_ntoh_uint8(TemperatureMonitorC$data_pkt[sim_node()].msg_id.nxdata));
  __nesc_hton_uint16(msg->temperature.nxdata, __nesc_ntoh_uint16(TemperatureMonitorC$data_pkt[sim_node()].temperature.nxdata));

  if (TemperatureMonitorC$AMSend$send(TemperatureMonitorC$prev_node[sim_node()], &TemperatureMonitorC$pkt[sim_node()], sizeof(data_msg_t )) == SUCCESS) {
      TemperatureMonitorC$busy[sim_node()] = TRUE;
      sim_log_debug(52U, "radio", "%s | Node %d | Forwarded DATA (ID=%d): temp = %d\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint8(msg->msg_id.nxdata), __nesc_ntoh_uint16(msg->temperature.nxdata));
    }
}

# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t TemperatureMonitorC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void TemperatureMonitorC$TimerSensor$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(1U, dt);
#line 64
}
#line 64
inline static void TemperatureMonitorC$TimerSink$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 166 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$AMControl$startDone(error_t err)
#line 166
{
  ...
  if (err == SUCCESS) {
      ...
      sim_log_debug(54U, "nodes", "%s | Node %d | Radio started\n", sim_time_string(), TOS_NODE_ID);

      if (TOS_NODE_ID == 0) {
          TemperatureMonitorC$TimerSink$startPeriodic(30000);
        }
      else {
          TemperatureMonitorC$TimerSensor$startPeriodic(5000);
        }
    }
  else 
#line 178
    {
      sim_log_error(55U, "error", "%s | Node %d | Error booting\n", sim_time_string(), TOS_NODE_ID);
...
#line 113
  TemperatureMonitorC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
inline static void TemperatureMonitorC$TimerSensor$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(1U);
#line 78
}
#line 78
inline static void TemperatureMonitorC$TimerSink$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(0U);
#line 78
}
#line 78
# 184 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$AMControl$stopDone(error_t err)
#line 184
{

  if (TOS_NODE_ID == 0) {
      TemperatureMonitorC$TimerSink$stop();
    }
  else {
      TemperatureMonitorC$TimerSensor$stop();
    }

  sim_log_debug(56U, "nodes", "%s | Node %d | Stopped\n", sim_time_string(), TOS_NODE_ID);
}

# 138 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static void TossimPacketModelC$Control$stopDone(error_t error){
#line 138
  TemperatureMonitorC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7fe0451ce060, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7fe0451ce060, msg, error);
#line 110
}
#line 110
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  TemperatureMonitorC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7fe044d42318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fe044d42318) {
#line 100
    case 0U:
#line 100
      /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7fe044d42318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7fe045552ab0){
#line 75
  switch (arg_0x7fe045552ab0) {
#line 75
    case TemperatureMonitorC$sendSETUP:
#line 75
      TemperatureMonitorC$sendSETUP$runTask();
#line 75
      break;
#line 75
    case TemperatureMonitorC$forwardSETUP:
#line 75
      TemperatureMonitorC$forwardSETUP$runTask();
#line 75
      break;
#line 75
    case TemperatureMonitorC$sendDATA:
#line 75
      TemperatureMonitorC$sendDATA$runTask();
#line 75
      break;
#line 75
    case TemperatureMonitorC$forwardDATA:
#line 75
      TemperatureMonitorC$forwardDATA$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7fe045552ab0);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7fe044d41488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7fe044d41488, addr, msg, len);
#line 80
...
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t TemperatureMonitorC$sendSETUP$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TemperatureMonitorC$sendSETUP);
#line 67
...
# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
inline static uint16_t TemperatureMonitorC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 197 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$TimerSink$fired(void )
#line 197
{

  TemperatureMonitorC$threshold[sim_node()] = TemperatureMonitorC$Random$rand16() % 20 + 50;
  sim_log_debug(57U, "nodes", "%s | Node 0 | New threshold %d.\n", sim_time_string(), TemperatureMonitorC$threshold[sim_node()]);
  TemperatureMonitorC$sendSETUP$postTask();
}

# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 20
{
  /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/usr/src/tinyos/tos/interfaces/Read.nc"
inline static error_t TemperatureMonitorC$Temperature$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$read();
#line 55
...
#line 55
# 204 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$TimerSensor$fired(void )
#line 204
{
  TemperatureMonitorC$Temperature$read();
}

# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t TemperatureMonitorC$forwardSETUP$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TemperatureMonitorC$forwardSETUP);
#line 67
...
#line 67
# 208 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$WaitingTimer$fired(void )
#line 208
{
  TemperatureMonitorC$forwardSETUP$postTask();
}

# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
inline static uint16_t /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t TemperatureMonitorC$sendDATA$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TemperatureMonitorC$sendDATA);
#line 67
...
#line 67
# 212 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$Temperature$readDone(error_t err, uint16_t val)
#line 212
{
  if (err == SUCCESS) {
      TemperatureMonitorC$temperature[sim_node()] = val;
      TemperatureMonitorC$measurements[sim_node()]++;
      sim_log_debug(58U, "nodes", "%s | Node %d | Read temp = %d\n", sim_time_string(), TOS_NODE_ID, TemperatureMonitorC$temperature[sim_node()]);

      if (TemperatureMonitorC$temperature[sim_node()] > TemperatureMonitorC$threshold[sim_node()]) {
          TemperatureMonitorC$sendDATA$postTask();
        }
    }
}

# 63 "/usr/src/tinyos/tos/interfaces/Read.nc"
inline static void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$readDone(error_t result, /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$val_t val){
#line 63
  TemperatureMonitorC$Temperature$readDone(result, val);
#line 63
}
#line 63
# 25 "TemperatureSensorP.nc"
static inline void /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$fired(void )
#line 25
{
  /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Read$readDone(SUCCESS, /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Random$rand16() % 70);
}
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7fe044de5c28){
#line 83
  switch (arg_0x7fe044de5c28) {
#line 83
    case 0U:
#line 83
      TemperatureMonitorC$TimerSink$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      TemperatureMonitorC$TimerSensor$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      TemperatureMonitorC$WaitingTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      /*TemperatureMonitorAppC.TSensor.TemperatureSensorP*/TemperatureSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7fe044de5c28);
#line 83
      break;
#line 83
    }
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 62
# 152 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$Boot$booted(void )
#line 152
{

  TemperatureMonitorC$threshold[sim_node()] = 70;
  TemperatureMonitorC$temperature[sim_node()] = 0;
  TemperatureMonitorC$busy[sim_node()] = FALSE;
  TemperatureMonitorC$counter[sim_node()] = 0;
  TemperatureMonitorC$dataCounter[sim_node()] = 0;
  TemperatureMonitorC$sentCounter[sim_node()] = 0;
  TemperatureMonitorC$measurements[sim_node()] = 0;
  sim_log_debug(53U, "nodes", "%s | Node %d | Booted.\n", sim_time_string(), TOS_NODE_ID);
  TemperatureMonitorC$AMControl$start();
}
...
#line 60
  TemperatureMonitorC$Boot$booted();
#line 60
}
#line 60
...
# 144 "TemperatureMonitorC.nc"
static void TemperatureMonitorC$AMSend$sendDone(message_t *msg, error_t err)
#line 144
{
  if (&TemperatureMonitorC$pkt[sim_node()] == msg && err == SUCCESS) {
      TemperatureMonitorC$sentCounter[sim_node()]++;
      TemperatureMonitorC$busy[sim_node()] = FALSE;
    }
}
...
#line 55
{
  /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 231);
  return /*TemperatureMonitorAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "TemperatureMonitorC$threshold"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$threshold[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$threshold[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$temperature"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$temperature[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$temperature[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$maxTemp"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$maxTemp[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$maxTemp[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$counter"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$counter[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$dataCounter"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$dataCounter[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$dataCounter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$sentCounter"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$sentCounter[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$sentCounter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$measurements"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$measurements[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$measurements[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$busy"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$busy[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$pkt"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$pkt[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$setup_pkt"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$setup_pkt[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$setup_pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$data_pkt"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$data_pkt[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$data_pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TemperatureMonitorC$prev_node"))
  {
    *addr = (uintptr_t)&TemperatureMonitorC$prev_node[__nesc_mote];
    *size = sizeof(TemperatureMonitorC$prev_node[__nesc_mote]);
    return 0;
  }
...
{
  /* Module TemperatureMonitorC */
  memset((void *)&TemperatureMonitorC$threshold[__nesc_mote], 0, sizeof TemperatureMonitorC$threshold[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$temperature[__nesc_mote], 0, sizeof TemperatureMonitorC$temperature[__nesc_mote]);
  TemperatureMonitorC$maxTemp[__nesc_mote] = 0;
  memset((void *)&TemperatureMonitorC$counter[__nesc_mote], 0, sizeof TemperatureMonitorC$counter[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$dataCounter[__nesc_mote], 0, sizeof TemperatureMonitorC$dataCounter[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$sentCounter[__nesc_mote], 0, sizeof TemperatureMonitorC$sentCounter[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$measurements[__nesc_mote], 0, sizeof TemperatureMonitorC$measurements[__nesc_mote]);
  TemperatureMonitorC$busy[__nesc_mote] = FALSE;
  memset((void *)&TemperatureMonitorC$pkt[__nesc_mote], 0, sizeof TemperatureMonitorC$pkt[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$setup_pkt[__nesc_mote], 0, sizeof TemperatureMonitorC$setup_pkt[__nesc_mote]);
  memset((void *)&TemperatureMonitorC$data_pkt[__nesc_mote], 0, sizeof TemperatureMonitorC$data_pkt[__nesc_mote]);
  TemperatureMonitorC$prev_node[__nesc_mote] = 0;
